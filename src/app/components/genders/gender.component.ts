    ...
    Swal.fire(
      ...
      if (result.isConfirmed) {
        if (this.reg.idGender === 0){
          ...
          this.api.put(this.controller,this.reg, this.reg.idGender).subscribe(
            (resp: any)=>{
            if (resp.error) {
