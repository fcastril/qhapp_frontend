...
export class CreditNoteComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
    ...
    ngOnInit(): void {
      ...
      this.api.getId('TypesMovements/GetOption', '52').subscribe(
        (resp: any) =>{
      ...
      // List reasons movements
      this.api.getId('ReasonsMovements/GetOption', '52').subscribe(
        (resp: any) =>{
          this.ReasonsMovements = resp;
        }
      );
      // List types Payments
    ...
    Submit( form: NgForm){
      ...
      Swal.fire(
        ...
        if (result.isConfirmed) {
          ...
          this.reg.idReasonMovement = Number(this.reg.idReasonMovement);
          ...
          if (this.reg.idMovement === 0){
            ...
            this.api.post('Movements',this.reg).subscribe(
              ...
              if (resp.error) {
                ...
                window.location.replace(`/credit-notes/${resp.idMovement}`);
              }
            });
          } else {
