...
export class DebitNoteComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute,
    ...
    ngOnInit(): void {
      ...
      this.api.getId('TypesMovements/GetOption', '53').subscribe(
        (resp: any) =>{
      ...
      // List Reasons Movement
      this.api.getId('ReasonsMovements/GetOption', '53').subscribe(
        (resp: any) =>{
          ...
          if (this.reg.idMovement === 0){
            ...
            this.api.post('Movements',this.reg).subscribe(
              ...
              if (resp.error) {
                ...
                window.location.replace(`/debit-notes/${resp.idMovement}`);
              }
            });
          } else {
