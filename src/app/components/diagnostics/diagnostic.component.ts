...
export class DiagnosticComponent implements OnInit {
  ...
  navigateToPage='/diagnostics';
  subtitle: string;
  reg = new DiagnosticModel();
    ...
    Swal.fire(
      ...
      if (result.isConfirmed) {
        if (this.reg.idDiagnostic === 0){
          ...
          this.api.put(this.controller,this.reg, this.reg.idDiagnostic).subscribe(
            (resp: any)=>{
            if (resp.error) {
